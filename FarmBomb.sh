...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border Farmer1337
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/FarmingBombsChat \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/farmer1337 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of FarmBomber for more stability."
    echo " "
}
